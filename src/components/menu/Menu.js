        ...
        <Navbar sticky={"top"} expand={"lg"} bg="dark" variant="dark" className={"mb-1"}>
            <Container>
                ...
                <Nav className="navbar navbar-dark bg-dark me-auto">
                    ...
                    <Button onClick={basketRoute} style={{width: "3rem",height: "3rem", position: "relative"}} variant={"outline-light"} className={"rounded-circle"}>
                    ...
                    {user && user.auth  ?
                        ...
                        :
                        <Button onClick={userRoute}  style={{marginLeft: "10px"}}
                                variant={"outline-light"}>
                            УВІЙТИ
                        </Button>
                    }
                    {user && user.auth  ?
                        <Button onClick={e => logOut(e)} style={{width: "3rem",height: "3rem", position: "relative", marginLeft: "10px"}} variant={"outline-light"} className={"rounded-circle"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                 className="bi bi-box-arrow-right" viewBox="0 1 16 16">
                                <path
